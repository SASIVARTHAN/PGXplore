...
import { redirectToLogin, isLegalPage, logoutToLanding } from '../utils/navigation'
...
export default function Header() {
  ...
  return (
    <header className="pointer-events-auto sticky top-0 z-50 hidden border-b border-app bg-elevated backdrop-blur md:block">
