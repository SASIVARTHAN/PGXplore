...
public class AuthController {
    ...
    @Operation(
            summary = "Firebase login (Google or phone via Firebase Authentication)",
            description = "Verify a Firebase ID token from Google popup or phone OTP, auto-register user, and return JWT.")
    @ApiResponses({
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
                    responseCode = "200",
